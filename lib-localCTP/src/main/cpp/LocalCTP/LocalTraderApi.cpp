...
void CThostFtdcTraderApi::startSettlementMonitor(const std::string &instrument_csv_path) {
    CLocalTraderApi::startSettlementMonitor(instrument_csv_path);
}

void CLocalTraderApi::startSettlementMonitor(const std::string &instrument_csv_path) {
    CSettlementHandler::getSettlementHandler(instrument_csv_path, sqlHandler);
}

void CLocalTraderApi::initInstrMap(const std::string &instrument_csv_path)
{
...
//        std::ifstream ifs("instrument.csv");
        std::ifstream ifs(instrument_csv_path);
        if (!ifs.is_open())
        {
            return false;
        }
